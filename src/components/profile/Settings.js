...
const Settings = () => {
  ...
  const [settings, setSettings] = useState({
    ...
    subscription: {
      ...
      status: 'Active',
      nextBilling: 'N/A',
      features: ['Basic matching', '5 likes per day', 'Standard filters']
    }
  });
  ...
  const renderSubscriptionSection = () => (
    <div className="settings-section-content">
      <div className="settings-group">
        <div className="settings-group-header">
          <h4><i className="fas fa-crown"></i> Your Plan</h4>
        ...
        <div className="subscription-card">
          <div className="subscription-header">
            <div className="subscription-plan">
              ...
              <div>
                <h4>{settings.subscription.plan} Plan</h4>
                <div className={`plan-status ${settings.subscription.status.toLowerCase()}`}>
                  {settings.subscription.status}
                </div>
              </div>
            </div>
            <div className="subscription-price">
              <span className="price">K0</span>
      ...
      <div className="settings-group">
        ...
        <div className="settings-card">
          ...
          <div className="settings-action-item">
            ...
            <button className="settings-action-btn" onClick={() => window.open('https://example.com/rate', '_blank')}>
              Rate
            </button>
          </div>
          ...
          <div className="settings-item">
            <div className="settings-item-info">
              ...
              <div>
                <h5>App Version</h5>
                <p>Version {process.env.REACT_APP_VERSION || '1.0.0'} (Build {process.env.REACT_APP_BUILD_DATE || '2024.03.15'})</p>
              </div>
            </div>
          </div>
        </div>
